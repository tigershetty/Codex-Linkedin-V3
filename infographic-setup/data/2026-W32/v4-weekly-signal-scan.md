# V4 Weekly Signal Scan — Pilot Week 1
...
| Signal | Current evidence | What it means | What it does not mean |
|---|---|---|---|
| Audience size | 1,510 followers in the analytics export; Tiger reported 1,512 immediately after | Growth starts from a small-account constraint | Follower count alone does not define content quality |
| Tiger history | 58 mature public originals; all 50 private ranked rows reconcile | There is enough account history for within-Tiger comparisons | The ranked private subset is a complete failure census |
| Impression concentration | Top post 53.2%; top three 78.9%; top five 85.4% of export-period impressions | Current reach is outlier-dependent | We know why those posts won |
| Competitive extraction | 2,325 activities normalized to 2,173 canonical posts; validation passes | Current-market and Top-100 screening can inform experiments | The original balanced 24-creator design was achieved |
| Peer coverage | 20 radar / 15 decision / 10 strict creators; 14 histories left-censored | We can scout broadly and test strict sensitivity | Left-censored creators failed the cadence gate |
| Top-100 coverage | 73/100 references, 72 unique cases, 42 baseline-qualified | Matched image-case hypotheses are available | Top-100 proves cross-format superiority |
| Scout Queue | 15 exploratory `screen_A` combinations under a failed reliability gate | Week 1 has combinations worth manual investigation across at least two evidence layers | Automated screens, labels, or response ratios are validated topics or a ranked production list |

Sources: `references/linkedin-v4-stage0-research-spec.md` and the Stage-0 control workbook.

## 2. Week 1 Research Lanes

| Lane | Minimum collection | Acceptance rule | Output |
|---|---:|---|---|
| Tiger baseline | 5 high, 5 middle, and 5 low mature posts from the joined corpus | Compare at the same maturity point; separate format, problem, proof, artifact, and opening | Account patterns worth retesting |
| Current-market creators | Review the 20-creator radar panel; require decision/strict labels for stronger claims | Prioritise near-scale accounts; public interactions are directional, not impressions | Repeating practitioner problems and packaging hypotheses |
| Top-100 references | Use baseline-qualified cases plus the 63-case clean static visual lane | Use as curated-success mechanics, never as causal or cross-format proof | Image mechanics and promise structures to test |
| Practitioner pain | 10 public statements across planning, purchasing, and transformation | The post must describe a recognizable work decision, consequence, or recurring friction | Pain/problem evidence rows |
| Public proof | At least 1 primary or authoritative source per shortlisted candidate | A calculation, method, example, or artifact must be possible without invented data | Proof and artifact paths |
...
Select only after the admission board is complete. The functions below are portfolio jobs, not quotas for old series.
...
3. What would you inspect or decide first?
4. Where would the proposed method fail?
5. What remains uncertain?

No personal claim enters a draft before the relevant statement is approved in `tiger-source.md`.
