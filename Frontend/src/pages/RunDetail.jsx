            ...
            <div>
              ...
              {geminiOutput && (
                <div style={{ marginTop: "16px" }}>
                  ...
                  {/* Expand toggle — only shown when prompt is actually truncated */}
                  {promptIsTruncated && (
                    <button
...
const RUNNING_STATES = ["SCOUT_RUNNING", "RESEARCH_RUNNING", "MESSAGE_RUNNING", "CONTENT_RUNNING", "PROMPT_RUNNING"];
...
export default function RunDetail() {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* Human-readable state badge — replaces raw `State: {run.state}` */}
      ...
      {/* Draft view */}
      {(run.state === "DRAFT_READY" || run.state === "LINKEDIN_QUEUED" || run.state === "PUBLISHED" || run.state === "COMPLETE") && (
        <DraftView run={run} />
      )}
...
const containerStyle   = { maxWidth: "900px", margin: "0 auto", padding: "32px 16px" };
